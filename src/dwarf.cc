...
auto RegNameToNum(const std::string &reg) -> DW_OP {
  ...
  // google `dwarf register number mapping`
  static const std::unordered_map<std::string, DW_OP> table = {
    // x86 registers
    {"rax", DW_OP::DW_OP_reg0},
    {"rdx", DW_OP::DW_OP_reg1},
    {"rcx", DW_OP::DW_OP_reg2},
    {"rbx", DW_OP::DW_OP_reg3},
    {"rsi", DW_OP::DW_OP_reg4},
    {"rdi", DW_OP::DW_OP_reg5},
    {"rbp", DW_OP::DW_OP_reg6},
    {"rsp", DW_OP::DW_OP_reg7},
    {"r8", DW_OP::DW_OP_reg8},
    {"r9", DW_OP::DW_OP_reg9},
    {"r10", DW_OP::DW_OP_reg10},
    {"r11", DW_OP::DW_OP_reg11},
    {"r12", DW_OP::DW_OP_reg12},
    {"r13", DW_OP::DW_OP_reg13},
    {"r14", DW_OP::DW_OP_reg14},
    {"r15", DW_OP::DW_OP_reg15},
    {"rip", DW_OP::DW_OP_reg16},
  };

  if (table.find(reg) == table.end()) {
    std::cerr << "Note: register " << reg << " is not found" << std::endl;
